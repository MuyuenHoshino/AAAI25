...
"""
from layers.graph_transformer_layer_for_SAN import GraphTransformerLayer
...
class SAN_NodeLPE(nn.Module):
    ...
    def __init__(self, net_params):
        ...
        # self.embedding_h = nn.Embedding(32, GT_hidden_dim-LPE_dim)#Remove some embedding dimensions to make room for concatenating laplace encoding
        self.embedding_h = nn.Linear(32, GT_hidden_dim-LPE_dim)
        ...
        self.MLP_layer = MLPReadout(GT_out_dim, 1)
