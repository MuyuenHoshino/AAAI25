...
class VOCSuperpixels(InMemoryDataset):
    ...
    def download(self):
        ...
        print(self.url[self.slic_compactness][self.name])
        if self.url[self.slic_compactness][self.name] == "https://www.dropbox.com/s/8x722ai272wqwl4/voc_superpixels_edge_wt_region_boundary.zip?dl=1":
            path = "/home/guojiahe/GraphGPS/datasets/VOCSuperpixels/slic_compactness_30/edge_wt_region_boundary/raw/pascalvocsp.zip"
        if self.url[self.slic_compactness][self.name] == "https://www.dropbox.com/s/rk6pfnuh7tq3t37/voc_superpixels_edge_wt_only_coord.zip?dl=1":
            path = "/home/guojiahe/GraphGPS/datasets/VOCSuperpixels/slic_compactness_30/edge_wt_only_coord/raw/voc_superpixels_edge_wt_only_coord.zip"
        if self.url[self.slic_compactness][self.name] == "https://www.dropbox.com/s/2a53nmfp6llqg8y/voc_superpixels_edge_wt_coord_feat.zip?dl=1":
            path = "/home/guojiahe/GraphGPS/datasets/VOCSuperpixels/slic_compactness_30/edge_wt_coord_feat/raw/voc_superpixels_edge_wt_coord_feat.zip"
        # filename = self.url[self.slic_compactness][self.name].rpartition('/')[2]
