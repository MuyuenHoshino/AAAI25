...
class GatedGCNLayer_2hop(pyg_nn.conv.MessagePassing):
    ...
    def forward(self, batch):
        ...
        x = scatter(x[src_index], dst_index, 0, None, self.n_nodes, reduce='sum')
    ...
    def aggregate(self, sigma_ij, index, Bx_j, Bx):
        ...
        print("numerator_eta_xj")
        print(numerator_eta_xj)
        print(numerator_eta_xj.shape)
...
@register_layer('GatedGCNLayer_2hop')
class GatedGCNGraphGymLayer_2hop(nn.Module):
    """GatedGCN layer.
    ...
    def __init__(self, layer_config: LayerConfig, **kwargs):
        super().__init__()
        self.model = GatedGCNLayer_2hop(in_dim=layer_config.dim_in,
